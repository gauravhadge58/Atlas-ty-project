...
function ValidatorPage() {
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-br from-slate-50 via-indigo-50/60 to-white flex flex-col">
      <header className="px-6 py-4 flex-shrink-0">
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 justify-end">
            {/* Reference Table nav link */}
            <Link
              to="/reference-table"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold border border-indigo-200 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition-colors"
            >
